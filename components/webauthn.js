  ...
  if (authState == "registered") {
    ...
    form = (
      <form className="flex flex-col">
        ...
        <a
          onClick={() =>
            registerCredential(user, setRawId, authState, setAuthState)
          }
          className="bg-red-600 hover:bg-white hover:text-black border border-red text-white font-bold py-3 px-12 lg:px-8 duration-200 transition-colors mt-4 lg:mb-0"
        >
          Register
      ...
      <Container>
        <div className="flex mx-auto flex-col lg:flex-row items-center text-left justify-center">
          ...
          <div className="flex flex-col p-4 md:m-8 lg:w-1/3 border bg-black text-white">
            <h1 className="text-xl lg:text-2xl pb-2">
              This text is jumbled on purpose.
            </h1>
            <p className="pb-2">
              I want to demonstrate a new auth protocal called{" "}
              <a
                className="text-blue-300"
                href="https://auth0.com/blog/introduction-to-web-authentication/"
                target="_blank"
              >
                WebAuthn
              </a>
            ...
            <p className="pb-2">
              To unlock the text, connect a{" "}
              <a
                className="text-blue-300"
                href="https://www.nytimes.com/wirecutter/reviews/best-security-keys/"
                target="_blank"
              >
                USB authenticator
              </a>
              , or make sure your device has a built in one like{" "}
              <a
                className="text-blue-300"
              ...
              , and enter a username or email address below.
            </p>
            {form}
          </div>
        </div>
